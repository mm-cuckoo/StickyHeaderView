package com.cfox.stickyheaderview.stickyview;
 ...
 * <br/>PACKAGE_NAME : com.cfox.stickyheaderview.stickyview
 * <br/>AUTHOR : CFOX
 * <br/>MSG :
 * <br/>************************************************
 */
public class StickHeaderView  extends LinearLayout {
    ...
    public StickHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StickHeaderView);
        topOffset = a.getDimensionPixelSize(a.getIndex(R.styleable.StickHeaderView_hvp_topOffset), topOffset);
        a.recycle();
